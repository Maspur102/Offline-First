...
extension ArticleModelQuerySortBy
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> sortByIsBookmarked() {
    return QueryBuilder.apply(this, (query) {
...
extension ArticleModelQuerySortThenBy
  ...
  QueryBuilder<ArticleModel, ArticleModel, QAfterSortBy> thenByIsBookmarked() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBookmarked', Sort.asc);
    });
  }
...
extension ArticleModelQueryWhereDistinct
  ...
  QueryBuilder<ArticleModel, ArticleModel, QDistinct> distinctByIsBookmarked() {
    return QueryBuilder.apply(this, (query) {
...
extension ArticleModelQueryProperty
  ...
  QueryBuilder<ArticleModel, bool, QQueryOperations> isBookmarkedProperty() {
    return QueryBuilder.apply(this, (query) {
